           ...
           <div class="container">
               <div class="col-md-9 grid-gallery">
                    ...
                    <div class="col-md-4 grid-stn simpleCart_shelfItem">
                        ...
                        <div class="img"><img src="${product.productImage}"  alt="/" class="img-responsive gri-wid">
                                ...
                                <div class="info">
                                    ...
                                    <div class="pull-right styl-price">
                                        <p><a  href="index" class="item_add"><span class="glyphicon glyphicon-shopping-cart grid-cart" aria-hidden="true"></span> <span class=" item_price">$<i>${product.price}</i></span></a></p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div></div>
                            </div>
                        ...
                        <!-- ---------------------------------I hate my lifeeeeeeeeeeeeeee normal-------------------------------------------------------------------------------------------------hahahahahahaha --> 
                        <!-- normal -->   
