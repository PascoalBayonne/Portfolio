                    ...
                    <nav class="navbar navbar-default nav-menu" role="navigation">
                        ...
                        <div class="collapse navbar-collapse collapse-pdng" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav nav-font">
                                <li class="dropdown">
                                    <a href="product" class="dropdown-toggle" data-toggle="dropdown">Shop<b class="caret"></b></a>
                        ...
                        <a href="#"><img src="images/menu2.jpg" alt="/" class="img-rsponsive men-img-wid" /></a>
                                ...
                                <li class="dropdown">
                                    <a href="product" class="dropdown-toggle" data-toggle="dropdown">Women<b class="caret"></b></a>
                        ...
                        <a href="#"><img src="images/menu3.jpg" alt="/" class="img-rsponsive men-img-wid" /></a>
                                ...
                                <li class="dropdown">
                                    <a href="product" class="dropdown-toggle" data-toggle="dropdown">kids<b class="caret"></b></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="products.html">Tees</a></li>
                    ...
                    <div class="shocase-rt-bot">
                        ...
                        <ul>
                            <li class="ad-2-crt simpleCart_shelfItem">
                                <a class="btn item_add" href="order" role="button">Add To Cart</a>
                                <a class="btn" href="order" role="button">Buy Now</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="img"><img src="images/grid4.jpg" alt="/" class="img-responsive gri-wid"></div>
                            <div class="info">
                                ...
                                <div class="pull-right styl-price">
                                    <p><a  href="product" class="item_add"><span class="glyphicon glyphicon-shopping-cart grid-cart" aria-hidden="true"></span> <span class=" item_price">$190</span></a></p>
                                </div>
                                <div class="clearfix"></div>
                            </div></div>
                        </div>
        ...
        <div class="footer-grid">
            <div class="container">
                ...
                <div class="col-md-6 re-ft-grd">
                    <h3>Social</h3>
                    <ul class="social">
                        <li><a href="https://www.facebook.com/pascoal.bayonne" class="fb">facebook</a></li>
