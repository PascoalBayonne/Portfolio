...
${exception}
				...
				<p>If you have previously registered with us, <a href="#">click here</a></p>
				 <form:form modelAttribute="user" action="saveUser" method="post">
					<ul>
						<li class="text-info">Login Name: </li>
						<li><form:input path="firstName" type="text"
						class="validate[required,custom[onlyLetter],length[0,100]] feedback-input"
						placeholder="" id="firstName" /></li>
					</ul>
					<ul>
						<li class="text-info">User Name: </li>
						<li><form:input path="lastName" type="text"
						class="validate[required,custom[onlyLetter],length[0,100]] feedback-input"
						placeholder="" id="lastName" /></li>
					 </ul>				 
					<ul>
						<li class="text-info">Email: </li>
						<li><form:input path="email" type="text"
						class="validate[required,custom[email]] feedback-input" id="email"
						placeholder="" /></li>
					</ul>
					<ul>
						<li class="text-info">Password: </li>
						<li><form:input path="password" type="password"
						class="validate[required,custom[email]] feedback-input" id="email"
						placeholder="" /></li>
					</ul>
					...
					<ul>
						...
						<li><form:input path="contacts" type="text"
						class="validate[required,custom[onlynumbers]] feedback-input"
						id="contacts" placeholder="phone number" /></li>
					</ul>						
