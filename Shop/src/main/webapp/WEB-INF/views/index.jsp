...
<body>
    ...
    <div class="col-md-4 bottom-cd simpleCart_shelfItem">
     <form:form action="buyProduct" method="post">
     <div class="product-at ">
      ...
      <p class="tun">${product.product_Name}</p>
      <a class="item_add"><p class="number item_price">$<i>${product.price}</i></p></a>
     </div>
     </form:form>
    </div>
   </c:forEach>
			...
			<div class="header-top">
				...
				<div class="login-bars">
					<a class="btn btn-default log-bar" href="register.html"
						...
						href="signup.html" role="button">Login <sec:authorize
					...
					<sec:authorize access="hasRole('ROLE_ADMIN')">
						...
						<a class="btn btn-default log-bar" href="admin" role="button">Master
							Admin </a>
					...
					<sec:authorize access="isAuthenticated()">
						<a class="btn btn-default log-bar" href="profile" role="button">Profile</a>
					</sec:authorize>
					...
					<a class="btn btn-default log-bar"> <sec:authorize
							access="isAuthenticated()">
							<form:form action="logout" method="post">
								<button>logout</button>
							</form:form>
						...
						<div class="collapse navbar-collapse collapse-pdng"
							...
							<ul class="nav navbar-nav nav-font">
								<li class="dropdown"><a href="products"
									class="dropdown-toggle" data-toggle="dropdown">Shop<b
										class="caret"></b></a>
	...
	<div class="footer-grid">
		<div class="container">
			...
			<div class="col-md-6 re-ft-grd">
				<h3>Social</h3>
				<ul class="social">
					<li><a href="https://www.facebook.com/pascoal.bayonne"
		...
		<div class="copy-rt">
			<div class="container">
				<p>
					&copy; 2016 N-AIR All Rights Reserved. Design by <a
						href="http://www.w3layouts.com">Bayonne</a>
				</p>
			</div>
		</div>
	</div>
